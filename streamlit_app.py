...
def render_logo(size=112):
    """
    Render the Nile Harvest Foods logo using inline SVG.

    Using inline SVG avoids dependency on:
    - external image files
    - assets folders
    - relative paths
    - Streamlit image path issues
    """
    ...
    <svg
        ...
        role="img"
        aria-label="Nile Harvest Foods logo"
    >
...
def render_sidebar_logo(size=82):
    """
    Render smaller sidebar version of the same logo.
    """
