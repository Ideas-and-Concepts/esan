...
def safe_import(module_path, function_name):
    ...
    If the module fails to load, the application
    continues running and records the error.
    """
...
if not st.session_state.logged_in:
    ...
    if os.path.exists(logo_path):
        ...
        # Safe fallback if logo has not yet
        # been placed in the assets directory.
        st.markdown(
            """
            <div style="
                font-size:72px;
